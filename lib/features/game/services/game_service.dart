  ...
  RealtimeChannel subscribeToRaceStatus(String eventId, int totalClues,
    ...
    return _supabase
        ...
        .onPostgresChanges(
          ...
          callback: (payload) {
            debugPrint(
                '📡 Realtime Progress: Update detected for event $eventId');
        ...
        .onPostgresChanges(
          ...
          callback: (payload) {
            ...
            debugPrint(
                '🏁 Realtime Event Status: ${newRecord['status']} for event $eventId');
      ...
      debugPrint('📡 Realtime Subscription Status: $status ${error ?? ""}');
    });
  }
